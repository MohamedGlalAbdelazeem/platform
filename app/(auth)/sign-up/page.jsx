    ...
    <div className="grid md:grid-cols-2 items-center gap-y-8 bg-white max-w-7xl w-full shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-3xl overflow-hidden">
      ...
      {/* fullname */}
        <div className="grid lg:grid-cols-1 my-6">
          <div>
            ...
            <input name="name" type="text" className="bg-gray-100 w-full text-gray-800 text-sm px-4 py-3 rounded-md outline-blue-500" placeholder="Ex : Hisham Hassan " />
          </div>
        </div>
      {/* fullname */}
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        <div>
            ...
            <input name="name" type="text" className="bg-gray-100 w-full text-gray-800 text-sm px-4 py-3 rounded-md outline-blue-500" placeholder="Ex : Instructor " />
          </div>
          <div>
            <label className="text-gray-800 text-sm mb-2 block">Phone Number *</label>
            <input name="lname" type="text" className="bg-gray-100 w-full text-gray-800 text-sm px-4 py-3 rounded-md outline-blue-500" placeholder="Ex : 010 15 800 24 8" />
          </div>
        </div>
