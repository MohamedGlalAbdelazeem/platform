        ...
        <div className="w-10/12 sm:w-full mx-auto my-32">
            ...
            <div className="w-fit mx-auto grid grid-cols-1 lg:grid-cols-4 sm:grid-cols-2 gap-12 my-16">
                {chooseData.map((item, index) => (
                    <div key={index} className="group w-64 h-[200px] bg-gray-100 rounded-l-[50px] rounded-r-[50px] shadow-lg relative hover:ring hover:ring-shadesOfBlue transform duration-500 hover:scale-105 hover:shadow-xl">
                        <div className="bg-gray-200 flex justify-center items-center w-16 h-16 rounded-full absolute mx-auto right-0 left-0 -top-10 border-4 border-white group-hover:shadow-md transform duration-300">
