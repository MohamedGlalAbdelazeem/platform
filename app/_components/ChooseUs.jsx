...
function ChooseUs() {
  return (
    ...
    <div className="my-4 flex items-center before:mt-0.5 before:flex-1 before:border-t before:border-neutral-300 after:mt-0.5 after:flex-1 after:border-t after:border-neutral-300">
        <h3 className="mx-4 mb-0 text-center capitalize text-2xl md:text-xl font-normal text-shadesOfBlue">Why Choose Us?</h3>
    </div>
    <div>
    ...
    <div className="w-fit mx-auto grid grid-cols-1 lg:grid-cols-4 sm:grid-cols-2 gap-12 my-16">
        ...
        <div className="group w-64 h-96 bg-white dark:bg-shadesOfBlue shadow-md relative rounded-lg m-4 hover:ring hover:ring-shadesOfBlue dark:hover:ring-white transform duration-500 hover:scale-105 hover:shadow-xl">
            ...
            <div className="flex flex-col items-center justify-center absolute mx-auto inset-0 p-4">
                <div>
                    <h2 className="text-xl capitalize font-bold text-shadesOfBlue dark:text-slate-800 my-4 my-8">web development</h2>
                </div>
                <div>
                    <p className="text-center text-base dark:text-white">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Temporibus saepe odio, dolores corporis voluptatum nesciunt?</p>
                </div>
                <a className="flex mt-12 border-2 bottom-0 border-shadesOfBlue dark:border-slate-800 dark:text-slate-800 p-2 px-6 capitalize font-semibold text-shadesOfBlue rounded-md group-hover:bg-shadesOfBlue dark:group-hover:bg-slate-800 group-hover:text-white transform ease-in-out delay-75 opacity-85 hover:opacity-100" href="#">view details</a>
            </div>
        </div>
        {/* End Card Item 1 */}
        ...
        <div className="group w-64 h-96 bg-white dark:bg-shadesOfBlue shadow-md relative rounded-lg m-4 hover:ring hover:ring-shadesOfBlue dark:hover:ring-white transform duration-500 hover:scale-105 hover:shadow-xl">
            ...
            <div className="flex flex-col items-center justify-center absolute mx-auto inset-0 p-4">
                <div>
                    <h2 className="text-xl capitalize font-bold text-shadesOfBlue dark:text-slate-800 my-4 my-8">graphic design</h2>
                </div>
                <div>
                    <p className="text-center text-base dark:text-white">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Temporibus saepe odio, dolores corporis voluptatum nesciunt?</p>
                </div>
