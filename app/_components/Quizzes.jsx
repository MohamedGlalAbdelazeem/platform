...
function Quizzes() {
  return (
    <div className="border-t-[9px] border-b-[9px] border-dashed border-white bg-gray-400 text-white p-11 my-32">
    <div className=" max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className=" flex flex-col gap-8 lg:flex-row items-center">
            <div className="lg:w-1/2">
                ...
                <a href="#"
                    className="bg-white text-gray-900 py-3 px-6 rounded-3xl shadow-lg hover:shadow-xl transition duration-200">Get
