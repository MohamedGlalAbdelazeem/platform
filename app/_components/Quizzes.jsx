...
function Quizzes() {
  return (
    <section className="border-t-[9px] h-[430px] lg:h-[425px] border-b-[9px] border-dashed border-white bg-[#842A8C] text-white">
        <div className="grid max-w-screen-xl px-4 py-2  pb-8 mx-auto lg:gap-8 xl:gap-24  lg:grid-cols-12 ">
            <div className="mt-10  lg:mt-10  md:mt-16  sm:mt-11 lg:col-span-7">
