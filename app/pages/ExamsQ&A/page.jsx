        ...
        <div className="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16">
          <div className="  grid grid-cols-1 md:grid-cols-4 sm:grid-cols-2 gap-10">
              ...
              ["A","v","A","v","f","A","f","A"].map((item, index)=>{
                  return(
                      <div key={index} className="rounded-3xl  bg-slate-200 p-3 overflow-hidden shadow-lg">
                      <div className="px-1 py-2">
                          <div className="my-6 font-semibold text-lg  hover:text-indigo-600 transition duration-500 ease-in-out">
                              <h2>Anatomy</h2>
                          </div>
                          <ul className="w-full">
